  ...
  products: [
    {
      id: 1,
      name: 'Les roses',
      logo: 'vendeur_rose.png',
      cout: 10,
      croissance: 1.15,
      revenu: 2,
      vitesse: 5, // Produit créé toutes les 5 secondes
      quantite: 1,
      timeleft: 0,
      ...
      paliers: [
        {
          ...
          logo: 'bang_kwang_Central.jpg.jpg',
          seuil: 200,
          idcible: 4,
          ratio: 2.5,
          typeratio: RatioType.vitesse,
    ...
    },
    {
      ...
      paliers: [
        ...
        {
          name: 'Le collier en diamant !',
          logo: 'collier_diamant.png',
          seuil: 2400,
          idcible: 5,
          ratio: 4,
          typeratio: RatioType.vitesse,
        ...
        {
          name: 'Le bracelet en rubis !',
          logo: 'bracelet_rubis.png',
          seuil: 4800,
          idcible: 5,
          ratio: 4.5,
          typeratio: RatioType.vitesse,
